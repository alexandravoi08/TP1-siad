...
subject to contrainte_2 {c in chemin}: sum {d in depart, a in arrivee} X[d,a]*Y[d,a,c]>0;
...
subject to contrainte_5 {a in arrivee, c in chemin}: sum {d in depart} Y[d,a,c]= sum {d in D} Y[d,a,c];
